...
router.get('/profile',async (req,res)=>{
    ...
    let avg=0;
    const ratings=profileData.ratedBy;
    if(ratings.length==0){
        avg=-1;
    }
    else{
...
router.get('/profile/:username',async (req,res)=>{
    ...
    if (loggedUser._id.equals(visitedUser._id)) {
    ...
    const playedWith = profileData.playedWith.some(playerId => playerId.equals(loggedUser._id));
